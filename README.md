...
A 22-slide HTML presentation introducing the Agency & AI Lab (A²L), a decentralized,
...
11. Behavioral-science and agency-measurement Claude Skills built with Irrational Labs (site and demo screenshots)
12. Part 3 divider: research on designing AI for agency
13. The Noora Health copilot study: aligning copilot design with MSEs' agency (with the Stanford Center for Health Education)
14. Three papers, one call: psychology inside AI design and evaluation (Zhao 2026; Josifović & Noller 2026; Economides et al. 2026)
...
20. The flagship study: measuring agency in naturalistic data (with Penn's LLM-judge method)
21. The six-NGO cohort: what we might learn with each partner
22. Close

Slides 2, 6, 17, 18, and 19 reuse content from the
